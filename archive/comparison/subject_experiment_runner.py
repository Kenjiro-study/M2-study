...
from .subject_negotiation_runner import NegotiationRunner, NegotiationConfig
    ...
    def _generate_model_combinations(self, config_name) -> List[Dict]:
        ...
        for buyer_model in self.config.models:
            for buyer_agent in self.config.agents:
                if buyer_agent == "damf" or buyer_agent == "search":
        ...
        for seller_model in self.config.models:
            for seller_agent in self.config.agents:
                if seller_agent == "damf" or seller_agent == "search":
