...
class NegotiationRunner:
    ...
    def _initialize_agents(self,config: NegotiationConfig):
        if config.buyer_model == "human":
            ...
            raise ValueError("This is a subject experiment, so please put a human in the seller or buyer role.")
        return buyer, seller
